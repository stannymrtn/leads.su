...
def test_ya_metric():
    ...
    yandex_metric.check_high_tooltips()
    yandex_metric.check_filtres_for_request()
    yandex_metric.check_aff_sub()
    yandex_metric.check_low_tooltips()
    yandex_metric.check_saved()
    yandex_metric.check_buttons()
    yandex_metric.check_filters()
    yandex_metric.check_download()
